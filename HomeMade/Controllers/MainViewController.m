...
- (void)configBaseView {
    ...
    UINavigationController *navigationController = [storyboard instantiateViewControllerWithIdentifier:@"BaseNavigationControllerViewController"];
    [navigationController setViewControllers:@[[storyboard instantiateViewControllerWithIdentifier:@"RootViewController"]]];
    
    UITabBarController * tab = [storyboard instantiateViewControllerWithIdentifier:@"TabBarController"];
